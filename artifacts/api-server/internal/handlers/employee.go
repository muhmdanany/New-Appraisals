...
// ListEmployees handles GET /employees, applying role-based visibility:
// ADMIN/HR see everyone; a manager sees only their reporting subtree.
...
// CreateEmployee handles POST /employees. Restricted to ADMIN/HR_MANAGER.
...
// UpdateEmployee handles PUT /employees/{id}. Restricted to ADMIN/HR_MANAGER.
...
// ImportEmployees handles POST /employees/import (two-pass). Restricted to ADMIN/HR_MANAGER.
